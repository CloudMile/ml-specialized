...
BASE_NAME="kkbox" # change to your model name

PACKAGE_PATH=../trainer # this can be a gcs location to a zipped and uploaded package
TRAIN_FILES=gs://${BUCKET}/kkbox/data/processed/transformed/tr.pkl
VALID_FILES=gs://${BUCKET}/kkbox/data/processed/transformed/vl.pkl
